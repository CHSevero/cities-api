package com.github.chsevero.citiesapi.distances;

import com.github.chsevero.citiesapi.distances.service.DistanceService;
...
public class DistanceResource {
    ...
    public ResponseEntity byPoints(@RequestParam(name = "from") final Long city1,
        ...
        log.info("byPoints");
        return ResponseEntity.ok().body(service.disntanceByPointsInMiles(city1, city2));
    }
